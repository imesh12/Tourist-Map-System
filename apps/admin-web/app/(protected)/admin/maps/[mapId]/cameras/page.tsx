...
export const metadata: Metadata = {
  title: 'Live Cameras — Tourist Map System',
};
...
/**
 * `/admin/maps/{mapId}/cameras` — LIVE CAMERAS FOUNDATION checkpoint, same
 * server-component shape every other map-scoped page uses:
 * `getOwnedMapContext(mapId)` verifies the requested map before
 * `loadTenantLiveCameras()` ever runs, scoped to THIS map only.
 */
export default async function CamerasPage({ params }: PageParams) {
