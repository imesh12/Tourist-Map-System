...
export function DiscoverPlacesDrawer({ mapId, eligibleCategories, existingPois, onClose, onImported }: DiscoverPlacesDrawerProps) {
          ...
          <div className="drawer-body">
            {eligibleCategories.length === 0 ? (
              <div className="empty-state">
                ...
                <Link href={`/admin/maps/${mapId}/categories`} className="btn btn-primary">
                  Go to Categories
                </Link>
              </div>
            ) : (
